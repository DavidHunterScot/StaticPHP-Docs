...
<pre class="w3-code" style="overflow-x: auto;">&lt;p&gt;--- metadata.some_key ---&lt;/p&gt;

&lt;p&gt;--- metadata.another_key ---&lt;/p&gt;</pre>
		
		<p>The output of having the metadata example and the above placeholders example will be like this.</p>

<pre class="w3-code" style="overflow-x: auto;">&lt;p&gt;some value&lt;/p&gt;

&lt;p&gt;another value&lt;/p&gt;</pre>
...
&lt;p&gt;This is a very awesome page. I am so glad you checked it out! :)&lt;/p&gt;</pre>
